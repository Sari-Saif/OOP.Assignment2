...
class Ex2_1Test
{
    ...
    public static final int NUM_OF_FILES_5 = 100000;
    ...
    {
        Ex2_1.createTextFiles(NUM_OF_FILES_5, 1, BOUND_2);
    }

    @Test
    void getNumOfLines()
    {
        String[] filenames = new String[NUM_OF_FILES_5];
        Ex2_1 threadsUsing = new Ex2_1();
        for(int i = 0; i < NUM_OF_FILES_5; i++)
        {
            filenames[i] = "text_files\\file_" + (i+1) + ".txt";
        }
       //assertEquals (57,threadsUsing.getNumOfLinesThreads(filenames));
        System.out.println(threadsUsing.getNumOfLinesThreads(filenames));
    }
    ...
    void getNumOfLinesThreadPool()
    {
        ...
        System.out.println(threadPoolUsing.getNumOfLinesThreadPool(filenames));
